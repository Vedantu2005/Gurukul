        ...
        <footer className="bg-gradient-to-br from-[#561C24] to-[#6D2932] text-[#E8D8C4] py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-4 gap-8 mb-8">
                    ...
                    {/* Logo + Description */}
                    <div>
                        <h4 className="text-xl font-bold mb-4">Saisanskrithi Gurukul</h4>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="/courses" className="hover:text-[#C7B7A3] transition">Courses</a></li>
                ...
                <div className="border-t border-[#C7B7A3] pt-8 text-center text-sm text-[#C7B7A3]">
                    <p>&copy; 2024 Saisanskrithi Gurukul. All rights reserved. Education Beyond Boundaries.</p>
                </div>
